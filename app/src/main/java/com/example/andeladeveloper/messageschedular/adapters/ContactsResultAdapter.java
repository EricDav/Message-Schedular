...
public class ContactsResultAdapter extends RecyclerView.Adapter<ContactsResultAdapter.ViewHolder> {
    private List<Contact> contacts;

    public ContactsResultAdapter(List<Contact> contacts) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            phoneNameTextView = view.findViewById(R.id.contactNameResultId);
            phoneNumberTextView = view.findViewById(R.id.contactNumberResultId);
        }
    }
    @Override
    public ContactsResultAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.result_contact_list, parent, false);
